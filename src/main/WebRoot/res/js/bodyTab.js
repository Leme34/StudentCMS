    ...
    Tab.prototype.navBar = function(strData){
        ...
        for(var i=0;i<data.length;i++){
            ...
            if(data[i].children != undefined && data[i].children.length > 0){
                ulHtml += '<a>';
                if(data[i].favicon != undefined && data[i].favicon != ''){
                    if(data[i].favicon.indexOf("icon-") != -1){
                        ulHtml += '<i class="seraph '+data[i].favicon+'" data-icon="'+data[i].favicon+'"></i>';
                    }else{
                        ulHtml += '<i class="layui-icon" data-icon="'+data[i].favicon+'">'+data[i].favicon+'</i>';
                    }
                }
                ...
                for(var j=0;j<data[i].children.length;j++){
                    ...
                    if(data[i].children[j].favicon != undefined && data[i].children[j].favicon != ''){
                        if(data[i].children[j].favicon.indexOf("icon-") != -1){
                            ulHtml += '<i class="seraph '+data[i].children[j].favicon+'" data-icon="'+data[i].children[j].favicon+'"></i>';
                        }else{
                            ulHtml += '<i class="layui-icon" data-icon="'+data[i].children[j].favicon+'">'+data[i].children[j].favicon+'</i>';
                        }
                    }
