...
public class ScoreController {
	...
	public String getAverage(@RequestParam("cid") Integer cid) {
		List<AverageScoreVo> averageList = scoreService.getAverageByCid(cid);

		Pagination<Course> page = new Pagination<Course>();

		page.setTotalItemsCount(scoreService.getTotalAverageScoreItemsCount(cid));

		String jsonStr = StrUtil.RETURN_JONS_PRE_STR
				+ page.getTotalItemsCount()
				+ StrUtil.RETURN_JONS_MID_STR
				+ JSON.toJSONString(averageList)
				+ StrUtil.RETURN_JONS_END_STR;
		System.out.println(jsonStr);
		return jsonStr;
	}
