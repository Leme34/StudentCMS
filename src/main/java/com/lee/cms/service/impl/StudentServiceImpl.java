...
import com.lee.cms.dao.StudentDao;
...
import com.lee.cms.utils.MD5Util;
...
@Service
@Transactional
public class StudentServiceImpl implements StudentService, LoginService {
	@Autowired
	...
	public List<Student> getStudentListByTid(Pagination<Student> page,
											 String tid, Integer cId) {
		return studentDao.getStudentListByTid(page, tid, cId);
	}
}
